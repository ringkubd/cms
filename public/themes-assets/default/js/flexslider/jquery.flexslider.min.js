(function($){var focused=!0;$.flexslider=function(el,options){var slider=$(el);if(typeof options.rtl=='undefined'&&$('html').attr('dir')=='rtl'){options.rtl=!0}
  ...
  if(typeof options==="object"){return this.each(function(){var $this=$(this),selector=(options.selector)?options.selector:".slides > li",$slides=$this.find(selector);if(($slides.length===1&&options.allowOneSlide===!1)||$slides.length===0){$slides.fadeIn(400);if(options.start){options.start($this)}}else if($this.data('flexslider')===undefined){new $.flexslider(this,options)}})}else{var $slider=$(this).data('flexslider');switch(options){case "play":$slider.play();break;case "pause":$slider.pause();break;case "stop":$slider.stop();break;case "next":$slider.flexAnimate($slider.getTarget("next"),!0);break;case "prev":case "previous":$slider.flexAnimate($slider.getTarget("prev"),!0);break;default:if(typeof options==="number"){$slider.flexAnimate(options,!0)}}}};$('#text-news').flexslider({animation:"slide",direction:"vertical",pauseOnHover:!0,controlNav:!1,animationLoop:!0,slideshowSpeed:2500,slideshow:!0,})})(jQuery)