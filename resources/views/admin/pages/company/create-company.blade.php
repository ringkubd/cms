      ...
      <div class="col-md-7">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Register new Company</h3>
            <a href="{{url("admin/company")}}" class="btn btn-link">show all</a>
          </div>
          <div class="box-body">
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 form-group">
                ...
                <input type="text" name="companyLocation" value="{{old('companyLocation')}}" class="form-control"
                  id="companyLocation" placeholder="Company Location">
            ...
            <div class="row">
              <div class="col-sm-12 form-group">
                ...
                <textarea name="companyAddress" id="companyAddress" rows="2" maxlength="200" class="form-control"
                  placeholder="Company Address">{{old('companyAddress')}}</textarea>
            ...
            <div class="form-group">
              ...
              <a href="{{ url('company/create') }}" class="btn btn-danger">Reset</a>
            </div>
