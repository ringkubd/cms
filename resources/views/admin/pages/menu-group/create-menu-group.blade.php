  ...
  <div class="row">
    <div class="col-md-8">
      <div class="box box-info">
        ...
        <div class="box-body">
          <form action="{{ url("admin/group-menu")}}" method="POST" class="form-horizontal">
            @csrf
            <div class="form-group">
              <label for="groupname" class="col-sm-2 control-label">Group Name</label>
              <div class="col-sm-10">
                <input type="text" name="groupname" value="{{old("groupname")}}" class="form-control" id="groupname"
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="{{ url("admin/group-menu/create") }}" class="btn btn-danger" title="Reset form">Reset</a>
              </div>
            </div>
          </form>
