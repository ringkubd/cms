    ...
    <div class="col-md-8">
      <div class="box box-info">
        <div class="box-header with-border">
          ...
          <a href="{{ url("admin/group-menu") }}" class="nav-link">show all</a>
        </div>
        <div class="box-body">
          <form action="{{ url("admin/group-menu/{$groupMenu->id}")}}" method="POST" class="form-horizontal">
            @csrf
            @method("PUT")
            <div class="form-group">
              <label for="groupname" class="col-sm-2 control-label">Group Name</label>
              <div class="col-sm-10">
                <input type="text" name="groupname" value="{{$groupMenu->name}}" class="form-control" id="groupname"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="description" id="description"
                  placeholder="description">{{$groupMenu->description}}</textarea>
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                ...
                <a href="{{ url("admin/group-menu/{$groupMenu->id}/edit") }}" class="btn btn-danger"
