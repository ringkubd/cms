...
@section('title', 'Create Your Notes')
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="text" name="note_title" value="{{old('note_title')}}" class="form-control"
              ...
              <div class="form-group">
                ...
                <textarea name="note_content" id="description"
                          class="form-control editor">{{old('note_content')}}</textarea>
                @error('note_content')
                <p class="text-danger margin-bottom-none">{{$message}}</p>
                @enderror
              </div>
            ...
            <div class="box-body">
              <div class="row">
                <div class="form-group col-sm-12">
                  ...
                  <label class="radio-inline">
                    <input type="radio" name="note_status" value="draft" class="checking" @if(old('note_status') == 'draft') checked @endif>
                    Draft
                  </label>
                  <label class="radio-inline">
                    <input type="radio" name="note_status" value="schedule" class="checking"  @if(old('note_status') == 'schedule') checked @endif>
                    Schedule
                  </label>
                </div>
                <div class="form-group col-sm-12 @if(old('note_status') !== 'schedule') hide @endif" id="scheduleDate">
                  <div class="form-group">
