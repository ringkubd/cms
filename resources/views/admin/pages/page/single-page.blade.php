    ...
    <div class="col-md-3">
      ...
      <div class="box box-primary">
        <div class="box-body box-profile">
          <img class="profile-user-img img-responsive img-circle" src="{{asset($post->post_thumb)}}"
            alt="User profile picture">
          <h3 class="profile-username text-center">{{ "{$post->post_title}"}}</h3>

          <p class="text-muted text-center">{{ $post->post_type}} Software Engineer</p>
          ...
          <div class="active tab-pane" id="activity">
            ...
            <div class="post">
              <div class="user-block">
                <img class="img-circle img-bordered-sm" src="{{asset($post->post_thumb)}}" alt="user image">
                <span class="username">
