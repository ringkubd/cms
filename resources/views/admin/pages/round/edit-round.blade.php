...
@section('content')
    ...
    <section class="content">
        <form action="{{ url("admin/round/{$round->id}") }}" method="POST">
            @method("put")
            @csrf
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit {{$round->name}}</h3>
                            <a href="{{url("admin/round/create")}}" class="btn btn-link">Register new</a>
                            <a href="{{url("admin/round/all")}}" class="btn btn-link">show all</a>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="active" value="1" {{ ($round->active == 1 ) ? "checked" : ""}}> Active
                                    </label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" name="roundName" value="{{old('roundName') ?? $round->name}}"
                                           class="form-control"
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select name="module_id" id="project" class="form-control longoption">
                                        @forelse ($modules as $module)
                                            @php $select = ($module->id == $round->module_id) ? "selected" : "" @endphp
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class='input-group dateTimePicker'>
                                        <input type='text' value="{{old("start_date") ?? web_date_format($round->start_time) }}" name="start_date"
                                               class="form-control"/>
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class='input-group dateTimePicker'>
                                        <input type='text' value="{{old("end_date") ?? web_date_format($round->end_time) }}" name="end_date"
                                               class="form-control"/>
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                            ...
                            <div class="row">
                                <div class="col-sm-12 form-group">
                                    ...
                                    <textarea name="description" id="description" rows="5" maxlength="400"
                                              class="form-control"
                                              placeholder="Round description">{{old('description') ?? $round->description }}</textarea>
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-green" value="Update" name="update-btn"
                                       title="submit">
                                <a href="{{ url("admin/round/{$round->id}/edit") }}" class="btn btn-danger">Reset</a>
                            </div>
