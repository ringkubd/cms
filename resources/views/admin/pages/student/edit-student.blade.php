            ...
            <div class="col-md-7">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Student - {{$student->name}}</h3>
                    ...
                    <div class="box-body">
                            ...
                            <div class="form-group col-sm-12">
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="active" value="1"
                                        {{ ($student->active == 1 ) ? "checked" : ""}}> Active
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" name="studentName" value="{{old('studentName') ?? $student->name}}"
                                    class="form-control" id="studentName" placeholder="Student name">
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="fatherName"
                                    value="{{old('fatherName') ?? $student->father_name}}" class="form-control"
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="motherName"
                                    value="{{old('motherName') ?? $student->mother_name}}" class="form-control"
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <select name="module_id" id="project" class="form-control longoption">
                                    ...
                                    @php $selected = (old("module_id") ?? $student->module_id == $module->id) ?
                                    "selected" : "" @endphp
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select name="round_id" id="round" class="form-control longoption">
                                    ...
                                    @php $selected = (old("round_id") ?? $student->round_id == $round->id) ? "selected"
                                    : "" @endphp
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <a href="{{url("admin/subject/create")}}" class="nav-link" title="create course">
                                    <i class="fa fa-link"></i>
                                </a>
                                <select name="course_id" id="course" class="form-control longoption">
                                    @forelse ($subjects as $subject)
                                    @php $selected = (old("course_id") ?? $student->subject_id == $subject->id) ?
                                    "selected" : "" @endphp
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select name="position_id" id="position" class="form-control longoption">
                                    ...
                                    @php $selected = (old("position_id") ?? $student->position_id == $position->id) ?
                                    "selected" : "" @endphp
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12">
                                ...
                                <select name="company_id" id="company" class="form-control longoption">
                                    ...
                                    @php 
                                      $selected = (old("company_id") ?? $student->company_id == $company->id) ? "selected" : "" 
                                    @endphp
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                              ...
                              <input type="text" name="profile_link" value="{{old('profile_link')}}" class="form-control" id="profile_link"
                                placeholder="www.upwork.com/ringkubd"  value="{{$student->profile_link}}">
                            ...
                            <div class="col-sm-6 form-group">
                              ...
                              <input type="text" name="expertise" value="{{old('expertise')}}" class="form-control" id="expertise"
                                placeholder="SEO Expert" value="{{$student->expertise}}">
                          ...
                          <div class="row">
                            <div class="col-sm-6 form-group">
                              ...
                              <select name="job_type" id="job_type" class="form-control select2">
                                <option value=""></option>
                                <option @if ($student->job_type == "freelancer")
                                    selected
                                @endif value="freelancer">Freelancer</option>
                                <option @if ($student->job_type == "it")
                                    selected
                                @endif value="it">IT</option>
                                <option @if ($student->job_type == "other")
                                    selected
                            ...
                            <div class="col-sm-6 form-check" style="padding-top: 2em!important">
                              ...
                              <input type="checkbox" value="1" name="is_success_stories" value="{{$student->is_success_stories}}"  class="form-check-input" id="is_success_stories">
                          ...
                          <div class="row">
                            <div class="form-group col-sm-12">
                              ...
                              <input id="thumbnail" class="form-control" type="text" name="profile_image" value="{{$student->profile_image}}">
                            ...
                            <img id="holder" style="margin-top:15px;max-height:100px;" src="{{$student->profile_image}}">
                          </div> <!-- .row -->
              
                        <div class="form-group">
                            <input type="submit" class="btn btn-green" value="Update" name="update-btn" title="submit">
                            <a href="{{ url("admin/student/{$student->id}/edit") }}" class="btn btn-danger">Reset</a>
                        </div>
            ...
            <div class="col-sm-5">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <p class="text-muted">
                            Select the Current Position for the success stories of the student. This field can't
                            empty.
                        </p>
                        <hr>
