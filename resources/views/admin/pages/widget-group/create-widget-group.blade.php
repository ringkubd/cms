...
<section class="content">
  <form action="{{ url('admin/widget-group') }}" method="POST">
    @csrf
    <div class="row">
      <div class="col-md-7">
        <!-- Form Element sizes -->
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Create new widget group</h3>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <a href="{{ url('admin/widget-group/create') }}" class="btn btn-danger">Reset</a>
            </div>
          </div> <!-- .box-body -->
        </div> <!-- .box -->
      </div> <!-- .col-md-7 -->
